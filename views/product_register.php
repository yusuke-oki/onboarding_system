            ...
            <form action="../controllers/product_register_controller.php" method="post">
                <div class="form-group">
                    <div class="row mt-5">  
                        ...
                        <input class="ms-2 col-3" type="text" name="item_cd" id="item_cd" >
                    </div>
                    <div class="row mt-5">
                        <label for="item_name" class="col-2">商品名</label>
                        <input class="ms-2 col-8" type="text" name="item_name" id="item_name" >
                    </div>
                    <div class="row mt-5">
                        <label for="itemdiv_selector" class="col-2">商品分類</label>
                        <select name="itemdiv_selector" size=1 id="itemdiv_selector" class="ms-2 col-5"></select>
                    </div>
                    <div class="row mt-5">
                        <label for="unit_price" class="col-2">商品単価</label>
                        <input class="ms-2 col-3" type="text" name="unit_price" id="unit_price">
                    ...
                    <div class="d-flex row mt-5 justify-content-end  ">
                        ...
                        <button class="col-2 ms-2 btn btn-outline-secondary" name="btn_action" value="pageback" type="submit">戻る
                    </div>
                </div>
            </form>
        </div>
